...
SELECT models.name, models.brand_name, brands.headquarters FROM models LEFT JOIN brands ON models.brand_name=brands.name WHERE models.name='Mustang';
...
SELECT brands.name, brands.founded FROM brands LEFT JOIN models ON models.brand_name=brands.name WHERE models.name IS NULL;
...
SELECT models.name, models.year FROM models, brands WHERE year=brands.founded;